...
ActiveRecord::Schema[7.0].define(version: 2023_09_30_123636) do
  ...
  create_table "list_cards", charset: "utf8mb4", collation: "utf8mb4_0900_ai_ci", force: :cascade do |t|
    t.bigint "list_id", null: false
    t.bigint "card_id", null: false
    t.datetime "created_at", null: false
    t.datetime "updated_at", null: false
    t.index ["card_id"], name: "index_list_cards_on_card_id"
    t.index ["list_id"], name: "index_list_cards_on_list_id"
  end
  ...
  add_foreign_key "list_cards", "cards"
  add_foreign_key "list_cards", "lists"
